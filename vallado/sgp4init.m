...
function [satrec] = sgp4init(whichconst, satrec, xbstar, xecco, epoch, ...
         xargpo, xinclo, xmo, xno, xnodeo,consts)
   ...
   [ainv,  ao,     satrec.con41,   con42,  cosio,  cosio2, einv,   eccsq,...
           ...
           satrec.satnum,tumin, mu, radiusearthkm, xke, j2, j3, j4, j3oj2);
   ...
   %if(satrec.error == 0)
       consts = [tumin, mu, radiusearthkm, xke, j2, j3, j4, j3oj2]; %added this to allow parallel computing
       [satrec, r, v] = sgp4(satrec, 0.0,consts);
   %end
